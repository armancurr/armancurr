...
export function About(props: InteractiveProps) {
  return (
    <section class="w-full">
      <div
        id="about"
        class="relative mx-auto grid h-[min(62vw,620px)] min-h-[360px] w-full max-w-6xl content-center border-x border-t border-neutral-900 px-6 hover:bg-white/[0.03] sm:px-8 md:px-10"
